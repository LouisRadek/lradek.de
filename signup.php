               ...
               <div class="form-inner">
                  <form action="includes/login.inc.php" class="login" method="POST">
                     ...
                     <div class="field">
                        ...
                        <div class="eye1" id="eye" onclick="toggle()">
                  ...
                  <form action="includes/signup.inc.php" class="signup" method="POST">
                     ...
                     <div class="field">
                        ...
                        <div class="eye2" id="eye" onclick="toggle2()">
                     ...
                     <div class="field">
                        ...
                        <div class="eye3" id="eye" onclick="toggle3()">
                     ...
                     <?php 
                        if (isset($_GET["error"])){
                           if ($_GET["error"] == "invalidEmail") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Your email is not valid!</div>';
                           } else if ($_GET["error"] == "invalidUid") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Choose a proper username!</div>';
                           } else if ($_GET["error"] == "passwordDismatch") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Password doesn`t match!</div>';
                           } else if ($_GET["error"] == "usernameTaken") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Username/Email already taken!</div>';
                           } else if ($_GET["error"] == "stmtFailed") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Something went wrong, try again!</div>';
                           } else if ($_GET["error"] == "none") {
                              echo '<div style="color:green; text-align:center; margin-bottom:-20px;">You have signed up!</div>';
                           } else if ($_GET["error"] == "emptyInput") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Fill out all boxes!</div>';
                           } else if ($_GET["error"] == "mailError") {
                              echo '<div style="color:red; text-align:center; margin-bottom:-20px;">Unreachable email address!</div>';
                           }
                        }
                     ?>
